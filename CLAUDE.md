...
### Vision du projet
Je développe **ShopLux**, une **plateforme e-commerce moderne et professionnelle** avec Laravel + Inertia + React. L'objectif est de créer une expérience utilisateur exceptionnelle avec toutes les fonctionnalités d'un vrai e-commerce prêt pour la production.
